...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    const { adopter_id, first_name, last_name, email, phone, address,
            type, occupation, org_reg_no } = req.body;

    await client.query(`
      INSERT INTO Adopters (adopter_id,first_name,last_name,email,phone,address)
      VALUES ($1,$2,$3,$4,$5,$6)
    `, [adopter_id, first_name, last_name, email, phone, address]);
